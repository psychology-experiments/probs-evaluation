...
EXPERIMENTAL_TASK_ONE_SOLUTION_SETTINGS = dict(Обновление=dict(blocks_finishing_task=1),
                                               Переключение=dict(trials_finishing_task=3,
                                                                 rule_changes_finishing_task=None),
                                               Торможение=dict(trials_finishing_task=3),
                                               )
...
data_saver = data_save.DataSaver(save_fp=f"data/WM/{participant_info['ФИО']}",
