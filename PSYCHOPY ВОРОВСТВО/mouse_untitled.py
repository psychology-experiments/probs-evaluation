...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\cognition\\data wok\\PycharmProjects\\Psychology experiments\\Probs evaluation\\PSYCHOPY ВОРОВСТВО\\mouse_untitled.py',
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *mouse* updates
        if mouse.status == NOT_STARTED and tThisFlip >= 0.1-frameTolerance:
